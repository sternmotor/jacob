...
Last commit info:
----------------------------------
LastChangedDate: $LastChangedDate: 2007-02-02 07:37:31 -0800 (Fri, 02 Feb 2007) $
Revision.......: $Rev: 824 $
...
class EnCryptError(CryptError):
    """ Alle Fehler beim verschluesseln """
    pass

class DeCryptError(CryptError):
    """ Alle Fehler beim entschluesseln """
    pass
...
def encrypt(txt, password, use_base64=True, use_bz2=False):
    """
    String >txt< mit >password< verschluesseln
    use_base64  - verschluesselter String wird mit base64 encodiert
...
def decrypt(txt, password, use_base64=True, use_bz2=False):
    """
    String >txt< mittels password entschluesseln
    """
    if use_base64:
        try:
